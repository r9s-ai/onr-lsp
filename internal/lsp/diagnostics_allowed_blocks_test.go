...
func TestAllowedBlocksForDirective(t *testing.T) {
	tests := []struct {
		...
		{name: "request after req map", dir: "after_req_map", want: []string{"request"}},
		...
		{name: "multi blocks", dir: "set_header", want: []string{"balance", "balance_mode", "models", "models_mode", "request"}},
		{name: "response", dir: "resp_map", want: []string{"response"}},
		{name: "error", dir: "error_map", want: []string{"error"}},
		{name: "metrics", dir: "usage_extract", want: []string{"metrics", "usage_mode"}},
		{name: "usage mode", dir: "usage_fact", want: []string{"metrics", "usage_mode"}},
